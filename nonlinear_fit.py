...
def generate_config(meas_data, kpos, kneg, params, device_type='RealDevice', filename=None, ref_config=None):
    ...
    match device_type:
        case 'RealDevice':
            ...
            config['device-params'][device_type]['writeVoltageLTP'] = np.abs(params['VEndNeg'])
            config['device-params'][device_type]['writeVoltageLTD'] = np.abs(params['VEndPos'])
            ...
            config['device-params'][device_type]['nonIdenticalPulse']['VinitLTP'] = np.abs(params['VStartNeg'])
            config['device-params'][device_type]['nonIdenticalPulse']['VstepLTP'] = params['stepSizeLTP']
            config['device-params'][device_type]['nonIdenticalPulse']['VinitLTD'] = np.abs(params['VStartPos'])
